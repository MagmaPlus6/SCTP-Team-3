...
@Order(Ordered.HIGHEST_PRECEDENCE)  // For exceptions, ResourceExceptionHandler takes precedence
...
public class ResourceExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleNoEntitiesFound(ResourceNotFoundException ex){
        Map<String, String> errorResponse = new HashMap<>();
